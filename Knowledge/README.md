...
This directory contains the project's structured knowledge layer: onboarding docs, architectural decisions, glossary, pipeline reference, and roadmap.
...
Your derived content goes in `Knowledge/local/`:
...
1. **Never modify files outside `local/`** in a derived repo. Template sync will overwrite your changes.
