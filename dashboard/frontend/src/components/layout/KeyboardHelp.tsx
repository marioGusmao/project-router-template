...
const shortcuts: { key: string; description: string }[] = [
  ...
  { key: 'A', description: 'Approve (detail panel open)' },
  { key: 'X', description: 'Reject (detail panel open)' },
  { key: 'D', description: 'Defer (detail panel open)' },
  { key: 'M', description: 'Ambiguous (detail panel open)' },
